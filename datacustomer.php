                                ...
                                <div class="table-responsive">
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalEdit<?=$idcus;?>">
                                                edit
                                            </button>
                                            
                                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modalDelete<?=$idcus;?>">
                                                delete
                                            </button>
                                            </td>
                                        </tr>
                                        <!--  edit -->
                                        <div class="modal fade" id="modalEdit<?=$idcus;?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <input type="text" name="kodemarking" value="<?=$kodemarking;?>" class="form-control" required>
                                            <br>
                                            ...
                                            <br>
                                            <input type="text" name="alamatcustomer" value="<?=$alamatcustomer;?>" class="form-control" required>
                                            <br>
                                            <input type="hidden" name="idcus" value="<?=$idcus;?>">
                                            <button type="submit" class="btn btn-primary" name="ubahdata">edit</button>
                                            <br>
                                     ...
                                     <!--  delete -->
                                     <div class="modal fade" id="delete<?=$idcus;?>">
                                        <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="post">
                                            <div class="modal-body">
                                                Apakah anda yakin ingin menghapus data <?$kodemarking;?>?
                                                <input type="hidden" name="idcus" value="<?=$idcus;?>">
                                            <br>
                                            <br>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
         ...
         <br>
         <input type="text" name="alamatcustomer" placeholder="Alamat" class="form-control" required>
         <br>
         <button type="submit" class="btn btn-danger" name="adddatacustomer">submit</button>
         <br>
