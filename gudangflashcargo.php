            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Rekapan Pesanan Gudang FlashCargo</h1>
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                    <?php
                                        $ambilsemuadatagudangfc = mysqli_query($conn,"SELECT * FROM gudangflashcargo");
                                        $i = 1;
                                        while($data=mysqli_fetch_array($ambilsemuadatagudangfc)){
